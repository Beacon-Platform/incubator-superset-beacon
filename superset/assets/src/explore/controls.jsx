...
export const controls = {
  ...
  unformatted_columns: {
    type: 'SelectControl',
    multi: true,
    label: t('Unformatted Columns'),
    default: [],
    description: t('One or more columns to exclude from numeric formatting'),
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.datasource.unformatted_columns : [],
    }),
  },
  ...
  pivot_margins_name: {
    type: 'TextControl',
    label: t('Override Pivot total column name'),
    renderTrigger: false,
    default: 'All',
  ...
  dark_mode: {
    ...
    renderTrigger: false,
    default: false,
    description: t('Render table in dark mode style'),
  },
  ...
  gravity: {
    ...
    description: t('Gravity in the force layout'),
  },
  ...
  friction: {
    ...
    description: t('Friction in the force layout'),
  },
  ...
  pivot_colormap: {
    ...
    description: t('Color map for Heatmap Table'),
  },

  pivot_interact: {
    type: 'CheckboxControl',
    label: t('Interactive Pivot'),
    renderTrigger: true,
    default: false,
    description: ('Enable interactive pivot grid controls'),
  },
  ...
  pivot_renderers: {
    ...
    default: 'Table',
    description: t('Renderers to apply when pivoting'),
  },
  ...
  color_bands: {
    type: 'CheckboxControl',
    label: t('Enable Color Bands'),
    renderTrigger: true,
    description: t('Enable color bands for table values'),
    default: true,
  },

  m1_label: {
    type: 'TextControl',
    label: t('Primary Metric Label'),
    default: 'm1',
  ...
  m2_label: {
    type: 'TextControl',
    label: t('Secondary Metric Label'),
    default: 'm2',
  ...
  number_alignment: {
    ...
    description: t('Numbers alignment.'),
  },
  ...
  label_rotation: {
    ...
    description: t('The label rotation (in degress) for X axis tick labels. ' +
    'Choose 0 for no rotation. ' +
    'Enter positive number from 0 to 90.'),
  },

  bars_orientation: {
    type: 'SelectControl',
    freeForm: false,
    label: t('Bars Orientation'),
    default: 'Vertical',
    choices: formatSelectOptions([
      'Vertical',
      'Horizontal',
    ]),
    description: t('Bars orientation.'),
  },
  ...
  bars_offset: {
    ...
    description: t('Bars offset for positive/negative bars in pixels.' +
    'Choose 0 for no offset. ' +
    'Enter positive or negative number from 0 to 50.'),
  },
};
